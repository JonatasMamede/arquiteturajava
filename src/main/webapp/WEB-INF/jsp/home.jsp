...
<body>
	<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
		<div class="container-fluid">
			<ul class="navbar-nav">
				...
				<li class="nav-item"><a class="nav-link" href="/limpeza/lista">Limpeza</a>
				</li>
			</ul>
	...
	<div class="container mt-3">
		...
		<span class="badge rounded-pill bg-primary">Vendedor:
			${qtdVendedor}</span> <span class="badge rounded-pill bg-secondary">Produto:
			${qtdProduto}</span> <span class="badge rounded-pill bg-success">Bebidas:
			${qtdBebida}</span> <span class="badge rounded-pill bg-danger">Limpeza:
			${qtdLimpeza}</span>
